...
public class ApiRateLimitFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return path == null || !path.contains("/api/analysis/");
    }
    ...
    protected void doFilterInternal(
        ...
        int perMinute = Math.max(5, rateLimitProperties.perMinute());
        ...
        synchronized (w) {
            ...
            if (w.count.incrementAndGet() > perMinute) {
                ...
                response.getWriter().write("{\"error\":\"RATE_LIMIT\",\"message\":\"Muitas requisições. Aguarde.\"}");
                return;
            }
        }
